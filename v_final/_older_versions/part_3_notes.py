...
# Colors
hex_colors = ['FFD966','FCE5CD', 'D9EAD3', '9FC5E8', 'EAD1DC']
...
with pd.ExcelWriter("teacher_schedule_colored_reordered.xlsx", engine='openpyxl') as writer:
    for day in ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']:
        ...
        reordered_cols = ['Note 1', 'Note 2', 'Time', 'Note 3', 'Note 4', 'Note 5']
...
for sheet_name in wb.sheetnames:
    ...
    for col_idx in range(7, num_cols + 1):  # Start from the 7rd column (after Note 1 and Note 2)
